		...
		<view class="u-cell__body" :class="[ center && 'u-cell--center', size === 'large' && 'u-cell__body--large']">
			<view class="u-cell__body__content">
				<view class="u-cell__left-icon-wrap" v-if="$slots.icon || icon">
					...
					<u-icon v-else :name="icon" :custom-style="iconStyle" :size="size === 'large' ? 33 : 22"></u-icon>
				</view>
...
<style lang="scss" scoped>
	...
	$u-cell-padding: 10px 10px !default;
	$u-cell-font-size: 15px !default;
	$u-cell-line-height: 24px !default;
	$u-cell-color: $u-main-color !default;
	$u-cell-icon-size: 20px !default;
	$u-cell-title-font-size: 20px !default;
	...
	$u-cell-value-font-size-large: 20px !default;
	$u-cell-label-font-size-large: 20px !default;
	$u-cell-title-font-size-large: 25px !default;
