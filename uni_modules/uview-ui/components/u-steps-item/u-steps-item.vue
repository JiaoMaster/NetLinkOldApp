<template>
	<view class="u-steps-item" ref="u-steps-item" :class="[`u-steps-item--${parentData.direction}`]">
		...
		<view class="u-steps-item__content" :class="[`u-steps-item__content--${parentData.direction}`]"
			:style="[contentStyle]">
			<u--text :bold="true" :text="title" :type="parentData.current == index ? 'main' : 'content'" lineHeight="20px"
				:size="parentData.current == index ? 22 : 20" ></u--text>
			<slot name="desc">
				<u--text :text="desc" type="tips" size="17"></u--text>
			</slot>
		</view>
		<!-- <view
